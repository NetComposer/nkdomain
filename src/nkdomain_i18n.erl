...
i18n() -> #{
    en => #{
        ...
        "domain_tree_resources__mail" => "eMails",
        "domain_tree_resources__mail.provider" => "eMail Providers",
        "domain_tree_resources__image.job" => "Image Jobs",
        "domain_tree_resources__image.processor" => "Image Processors",
        "domain_tree_resources__transcoding.server" => "Transcoding Servers",
        "domain_tree_resources__user" => "Users",

        "domain_tree_sessions" => "Sessions",
        "domain_tree_sessions__admin.session" => "Admin",
        "domain_tree_sessions__device" => "Devices",
    ...
    es => #{
        ...
        "domain_tree_resources__image.job" => "Imágenes Procesadas",
        "domain_tree_resources__image.processor" => "Procesadores de Imágenes",
        "domain_tree_resources__mail" => "eMails",
        "domain_tree_resources__mail.provider" => "Proveedores eMail",
        "domain_tree_resources__transcoding.server" => <<"Servidores de Transcodificación"/utf8>>,
        "domain_tree_resources__user" => "Usuarios",

        "domain_tree_sessions" => "Sesiones",
        "domain_tree_sessions__admin.session" => "Admin",
        "domain_tree_sessions__device" => "Dispositivos",
