...
i18n() -> #{
    en => #{
        ...
        'domain_tree_resources_mail.providers' => "eMail Providers",
        'domain_tree_resources_file.stores' => <<"File Stores">>,

        domain_tree_sessions => "Sessions",
        domain_tree_sessions_sessions => "Login",
        domain_tree_sessions_tokens => "Tokens",
        'domain_tree_sessions_admin.sessions' => "Admin",
    ...
    es => #{
        ...
        'domain_tree_resources_mail.providers' => "Proveedores eMail",
        'domain_tree_resources_file.stores' => <<"Stores de Ficheros">>,
