...
-export([object_info/0, object_parse/2, object_schema_types/0, object_admin_info/0, object_es_mapping/0]).
...
object_admin_info() ->
    #{
        class => resource,
        weight => 2102,
        type_view_mod => nkdomain_image_job_obj_type_view,
        obj_view_mod => nkdomain_image_job_obj_view
    }.
