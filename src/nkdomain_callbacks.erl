...
-export([object_db_find_obj/2, object_db_search_objs/4, object_db_delete_objs/4, object_db_agg_objs/4, object_db_agg_objs/5,
...
object_db_delete_objs(SrvId, Type, SearchType, DbOpts) ->
    ?CALL_NKROOT(object_db_delete_objs, [SrvId, Type, SearchType, DbOpts]).
...
object_db_agg_objs(SrvId, Type, Field, SearchType, DbOpts) ->
    ?CALL_NKROOT(object_db_agg_objs, [SrvId, Type, Field, SearchType, DbOpts]).
